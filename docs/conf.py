...
source_version = __version__  # noqa: F821
...
needs_sphinx = "8.0.2"  # numpydoc requires sphinx >= 1.0
...
latex_documents = [
    ("index", "afqbrowser.tex", "afqbrowser Documentation", "Ariel Rokem", "manual"),
]
...
man_pages = [("index", "afqbrowser", "afqbrowser Documentation", ["Ariel Rokem"], 1)]
